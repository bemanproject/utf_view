...
namespace p2728 {
  ...
  static_assert(utf_iter<std_archetypes::basic_input_iterator_archetype<char8_t, char8_t&,
                                                                       char8_t>>);
  static_assert(utf_iter<std_archetypes::basic_input_iterator_archetype<char16_t, char16_t&,
                                                                       char16_t>>);
  static_assert(utf_iter<std_archetypes::basic_input_iterator_archetype<char32_t, char32_t&,
                                                                       char32_t>>);
#ifdef WCHAR_T_IS_CODE_UNIT
  static_assert(utf_iter<std_archetypes::basic_input_iterator_archetype<wchar_t, wchar_t&,
                                                                       wchar_t>>);
#ifdef CHAR_IS_CODE_UNIT
  static_assert(utf_iter<std_archetypes::basic_input_iterator_archetype<char, char&,
                                                                       char>>);
#else
  static_assert(!utf_iter<std_archetypes::basic_input_iterator_archetype<char, char&,
                                                                        char>>);
  ...
  static_assert(!utf_iter<std_archetypes::basic_input_iterator_archetype<wchar_t, wchar_t&,
                                                                       wchar_t>>);
#endif
  static_assert(!utf_iter<std_archetypes::basic_input_iterator_archetype<int, int&, int>>);
