...
#### 24.7.?.4 Exposition-only class template `@*to-utf-view-impl*@` [range.transcoding.view.impl] {-}
...
#### 24.7.?.5 Class `@*to-utf-view-impl*@::@*iterator*@` [range.transcoding.view.impl.iterator] {-}

```c++
template<input_range V, to_utf_view_error_kind E, @*code-unit*@ ToType>
  requires view<V> && @*code-unit*@<range_value_t<V>>
template<bool Const>
class @*to-utf-view-impl*@<V, E, ToType>::@*iterator*@ {
private:
...
#### 24.7.?.6 Class `@*to-utf-view-impl*@::@*sentinel*@` [range.transcoding.view.impl.sentinel] {-}

```c++
template<input_range V, to_utf_view_error_kind E, @*code-unit*@ ToType>
  requires view<V> && @*code-unit*@<range_value_t<V>>
template<bool Const>
class @*to-utf-view-impl*@<V, E, ToType>::@*sentinel*@ {
private:
  using @*Parent*@ = @*maybe-const*@<Const, @*to-utf-view-impl*@>; // @*exposition only*@
  using @*Base*@ = @*maybe-const*@<Const, V>; // @*exposition only*@
...
#### 24.7.?.7 Class template `to_utf8_view` [range.transcoding.view.to_utf8]
...
#### 24.7.?.8 Class template `to_utf8_or_error_view` [range.transcoding.view.to_utf8_or_error]
...
#### 24.7.?.9 Class template `to_utf16_view` [range.transcoding.view.to_utf16]
...
#### 24.7.?.10 Class template `to_utf16_or_error_view` [range.transcoding.view.to_utf16_or_error]
...
#### 24.7.?.11 Class template `to_utf32_view` [range.transcoding.view.to_utf32]
...
#### 24.7.?.12 Class template `to_utf32_or_error_view` [range.transcoding.view.to_utf32_or_error]
