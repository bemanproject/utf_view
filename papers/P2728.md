...
public:
  ...
  friend constexpr auto operator<=>(@*iterator*@ const& lhs, @*iterator*@ const& rhs)
    requires (derived_from<typename iterator_traits<iterator_t<@*Base*@>>::iterator_category, random_access_iterator_tag>) &&
    same_as<char32_t, range_value_t<@*Base*@>> && same_as<char32_t, ToType>
  {
    return lhs.@*current_*@ <=> rhs.@*current_*@;
  }

  friend constexpr @*iterator*@& operator+=(@*iterator*@& it, iter_difference_t<iterator_t<@*Base*@>> const n)
    requires (derived_from<typename iterator_traits<iterator_t<@*Base*@>>::iterator_category, random_access_iterator_tag>) &&
    same_as<char32_t, range_value_t<@*Base*@>> && same_as<char32_t, ToType>
  {
    it.@*current_*@ += n;
    if (it.@*current_*@ != it.@*end*@())
      it.@*read*@();
    return it;
  }
  ...
  friend constexpr @*iterator*@ operator+(iter_difference_t<iterator_t<@*Base*@>> const n, @*iterator*@ it)
    requires (derived_from<typename iterator_traits<iterator_t<@*Base*@>>::iterator_category, random_access_iterator_tag>) &&
    same_as<char32_t, range_value_t<@*Base*@>> && same_as<char32_t, ToType>
  {
    it += n;
  ...
  friend constexpr iter_difference_t<iterator_t<@*Base*@>> operator-(@*iterator*@ const& lhs, @*iterator*@ const& rhs)
    requires (derived_from<typename iterator_traits<iterator_t<@*Base*@>>::iterator_category, random_access_iterator_tag>) &&
    same_as<char32_t, range_value_t<@*Base*@>> && same_as<char32_t, ToType>
  {
    return lhs.@*current_*@ - rhs.@*current_*@;
  ...
  constexpr char32_t operator[](iter_difference_t<iterator_t<@*Base*@>> const n) const
    requires (derived_from<typename iterator_traits<iterator_t<@*Base*@>>::iterator_category, random_access_iterator_tag>) &&
    same_as<char32_t, range_value_t<@*Base*@>> && same_as<char32_t, ToType>
  {
    return *(*this + n);
...
- If `V` models `random_access_range`, and
  `std::ranges::range_value_t<@*Base*@>` is `char32_t`, and `ToType` is
  `char32_t`, then `iterator_concept` is `random_access_iterator_tag`.
...
- If `C` models `derived_from<random_access_range>`, and
  `std::ranges::range_value_t<@*Base*@>` is `char32_t`, and `ToType` is
  `char32_t`, then `iterator_concept` is `random_access_iterator_tag`.
